...
function processBadges(cells) {
  ...
  var result = cells.map(function (cell) {
    ...
    //the actual badge class names, otherwise it will fail validation
    badge.name = badge.title;
    badge.image = badge.imgSrc;
    badge.issuer = 'http://discovery.openbadges.org';
    badge.criteria = badge.issuer; //no criteria...
