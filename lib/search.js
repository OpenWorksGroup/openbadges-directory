...
Search.prototype.create = function (callback) { return this.searchIndex.createIndex(callback); };
Search.prototype.refresh = function (callback) { return this.searchIndex.refresh(callback); };
Search.prototype.tags = function (options, callback) { return this.searchIndex.tags(options, callback); };
