...
function decorateResponse(elasticDoc) {
  if (elasticDoc.fields && elasticDoc.fields._timestamp) {
...
ElasticSearch.prototype.deleteByEndpoint = function (endpoint, callback) {
...
ElasticSearch.prototype.deleteById = function (id, callback) {
  //curl -XDELETE 'http://localhost:9200/twitter/tweet/1'
  request({
    method: 'DELETE',
    uri: config(HOST_VAR, DEFAULT_HOST) + '/badge_classes/badge_class/' + encodeURIComponent(id)
  }, function (error, response, body) {
    if (response.statusCode !== 200) {
      return callback(new Error('There was an issue deleting the index: ' + body));
    }
...
ElasticSearch.prototype._deleteByQuery = function (query, callback) {
  ...
  request({
    method: 'DELETE',
    uri: config(HOST_VAR, DEFAULT_HOST) + '/badge_classes/badge_class/_query',
...
ElasticSearch.prototype.issuers = function (options, callback) {
  var limit = options.limit || 0;
